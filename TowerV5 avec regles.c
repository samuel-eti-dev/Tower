...
void main()
{
  ...
  int g;
  printf("\nRegle du Jeu :\n");
  printf("\nChacun joue a tour de role. Jouer consiste a construire une tour sur une case. Un joueur peut jouer jusqu'a trois fois sur la meme case de facon a obtenir une tour de hauteur 3.");
  printf("\nToute tour posee donne une domination sur les cases adjacentes (y compris sur la case ou elle est posee). Si la tour est de hauteur n elle donne un controle de valeur n.");
  printf("\nLe plateau a son origine en 1-1 et se termine en 6-6.");
  printf("\nLe joueur 1 aura les nombre positifs (1,2,3), tandis que le joueur 2 aura les nombres negatif(-1,-2,-3).\n");
